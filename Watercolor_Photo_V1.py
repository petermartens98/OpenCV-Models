...
# Define image input path and watercolor output path
in_path = "C:\\Users\\Peter\\PycharmProjects\\Photo_To_Watercolor\\Peter Selfie.jpg"
out_path = in_path[:-4]
...
cv2.imwrite(out_path+"_watercolor.jpg", image_water)
...
image_water = rescale_frame(image_water, percent=50)
